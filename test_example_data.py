...
class TestExampleDataFile(unittest.TestCase):
    ...
    def test_artist_names_present(self):
        ...
        expected_artists = ['Taylor Swift', 'Drake', 'Billie Eilish', 'The Weeknd', 'BTS']
        found_artists = []
        ...
        self.assertGreater(len(found_artists), 0, 
    ...
    def test_edge_case_empty_artist_data(self):
        ...
        self.assertTrue(found_empty_data, "File should contain a line with empty artist_data")
...
class TestRequirementsFile(unittest.TestCase):
    ...
    def test_no_empty_lines_in_dependencies(self):
        ...
        for dep in core_deps:
            self.assertGreater(len(dep), 0, f"Core dependency line should not be empty: {dep}")
